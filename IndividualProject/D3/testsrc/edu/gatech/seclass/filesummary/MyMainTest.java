...
public class MyMainTest {
    ...
    // Frame #4
    // Failure Type: BUG: more than one argument are passed to the option
    @Test
    ...
    // Frame #12
    // Failure Type: BUG: empty argument passed to the option -s
    @Test
    ...
    // Frame #16
    // Failure Type: BUG: empty argument passed to the option -r
    @Test
    ...
    // Frame #20
    // Failure Type: BUG: all lines are removed
    @Test
    ...
    // Frame #32
    // Failure Type: BUG: empty argument passed to the option -a
    @Test
    ...
    // Frame #56
    // Failure Type: BUG: too large integer for the option -a
    @Test
    ...
    // Frame #2
    // Failure Type: BUG: negative integer passed to the option -a
    @Test
    ...
    // Frame #50
    // Failure Type: BUG: integer passed to option -a is out of the ability of the program
    @Test
    ...
    // New Failure Type: BUG: the second argument provided for option -r is invalid
    @Test
    public void filesummaryTest31() throws Exception {
        File inputFile31 = createInputFile(FILE15);

        String args[] = {"-r", "", "0", inputFile31.getPath()};
        Main.main(args);

        String expected31 = "Log: 123 abc\nError: 123 xyz\nError: 554ml5y967 abc\nLog: 567 abc";

        String actual31 = getFileContent(inputFile31.getPath());

        assertEquals("The files differ!", expected31, actual31);
        assertEquals("", outStream.toString().trim());
    }

    // New Failure Type: BUG: multiple same option passed
    @Test
    public void filesummaryTest32() throws Exception {
        File inputFile32 = createInputFile(FILE15);

        String args[] = {"-a", "-a", inputFile32.getPath()};
        Main.main(args);

        String expected32 = "Log: 123 abc\nError: 123 xyz\nError: 554ml5y967 abc\nLog: 567 abc";
    ...
    // New Failure Type: BUG: no argument provided for option -s
    @Test
    public void filesummaryTest33() throws Exception {
        File inputFile33 = createInputFile(FILE15);

        String args[] = {"-s", inputFile33.getPath()};
        Main.main(args);

        String expected33 = "Log: 123 abc\nError: 123 xyz\nError: 554ml5y967 abc\nLog: 567 abc";
    ...
    // New Failure Type: BUG: empty file
    @Test
    public void filesummaryTest34() throws Exception {
        File inputFile34 = createInputFile("");

        String args[] = {inputFile34.getPath()};
        Main.main(args);

        String expected34 = "Log: 123 abc\nError: 123 xyz\nError: 554ml5y967 abc\nLog: 567 abc";
    ...
    // New Failure Type: BUG: the file only has a white space
    @Test
    public void filesummaryTest35() throws Exception {
        File inputFile35 = createInputFile(" ");

        String args[] = {"-n", inputFile35.getPath()};
        Main.main(args);

        String expected35 = "Log: 123 abc\nError: 123 xyz\nError: 554ml5y967 abc\nLog: 567 abc";
